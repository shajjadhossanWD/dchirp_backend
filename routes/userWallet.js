...
router.get("/users/:walletAddress", auth, async (req, res) => {
    try {
        if (req.user) {
            res.json(req.user);
        }
...
router.put("/users/profileimg/:walletAddress", upload.single("profilePicture"), async (req, res) => {
    try {
...
router.put("/users/coverimg/:walletAddress", upload.single("coverPicture"), async (req, res) => {
    try {
